...
\hypertarget{temporarily-commented-out-links}{%
\section{Temporarily commented out links}\label{temporarily-commented-out-links}}
...
\hypertarget{git-not-ignoring-files-even-though-they-are-in-gitignore}{%
\section{git not ignoring files even though they are in gitignore}\label{git-not-ignoring-files-even-though-they-are-in-gitignore}}

\href{https://stackoverflow.com/questions/25436312/gitignore-not-working}{see here}
...
\textbf{Remember to commit everything you've changed before you do this!}
